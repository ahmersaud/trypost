            ...
            <div class="flex flex-col gap-8">
                <div class="flex flex-col items-center gap-4">
                    <Link :href="home()" class="flex flex-col items-center gap-2 font-medium">
                        <img src="/images/trypost/logo-light.png" alt="Apptech Social" class="dark:hidden h-8 w-auto" />
                        <img src="/images/trypost/logo-dark.png" alt="Apptech Social" class="hidden dark:block h-8 w-auto" />
                    </Link>
                </div>
